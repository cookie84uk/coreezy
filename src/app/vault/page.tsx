            ...
            <div className="card p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-4 rounded-lg bg-coreezy-800/50">
                  ...
                  <p className="text-sm text-coreezy-300">
                    The Vault receives additional boosts generated from{' '}
                    <strong className="text-canopy-400">Coreezy Vibes LLC</strong>. As
                    the brand expands into new projects, partnerships, merch, media, and
                    other ventures, those earnings flow back to the community through
                    the same vault mechanism.
                  </p>
                </div>
              </div>
